    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('Update Terms & Condition') }}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a
                            href="{{ route('admin.privacy-policy') }}">{{ __('Terms & Condition') }}</a></div>
                    <div class="breadcrumb-item">{{ __('Terms & Condition') }}</div>
                </div>
            </div>
            <div class="section-body">
                <a href="{{ route('admin.terms-condition') }}" class="btn btn-primary"><i class="fas fa-list"></i>
                    {{ __('terms-condition') }}</a>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
