    ...
    <section id="wsus__product_page" class="dynamic-pg py-5">
        <div class="container">
            <div class="position-relative">
                <img src="{{ asset('public/uploads/website-images/images/help-center.png') }}" class="w-100 banner-img">
                <div class="pt-0 h-100 d-flex align-items-center position-absolute banner-section">
                    <h1 class="mt-0 heading">E-industrify Help Center</h1>
                </div>
            </div>
            <div class="mt-4 row">
                <div class="col-xl-12 text-center">
                    <h4 class="mb-4">Access our Help Center for Timely and Accurate Solutions to your Problems!</h4>
                    ...
                    <div class="mt-3 mb-4 text-start row">
                        <div class="col-lg-4 col-md-6">
                            <div class="contact-eindus-block">
                                <div>
                                    <img src="{{ asset('public/uploads/website-images/images/dialer.png') }}" alt="dialer">
                                </div>
                                <div>
                        ...
                        <div class="col-lg-4 col-md-6 my-md-0 my-1">
                            <div class="contact-eindus-block">
                                <div>
                                    <img src="{{ asset('public/uploads/website-images/images/email.png') }}" alt="email">
                                </div>
                                <div>
                                    <h5 class="text-white d-block mb-3">Email</h5>
                                    <a href="mailto:info@eindustrify.com" class="text-white d-block text">info@eindustrify.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mt-lg-0 mt-md-3">
                            <div class="contact-eindus-block">
                                <div>
                                    <img src="{{ asset('public/uploads/website-images/images/location.png') }}" alt="location">
                                </div>
                                <div>
                                    <h5 class="text-white d-block mb-3">Address</h5>
                                    <p class="text-white d-block text">11111 Katy Freeway, Suite 910, Houston TX 77079</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p>Thank you for choosing E-industrify for your business needs. If you have any additional queries or concerns, please do not hesitate to reach out to our customer support team for assistance. We are here to help!</p>
                </div>
            </div>
