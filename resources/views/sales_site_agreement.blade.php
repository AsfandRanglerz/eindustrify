@extends('layout')
@section('title')
    <title>Sales Site Agreement</title>
@endsection
@section('meta')
    <meta name="description" content="Sales Site Agreement">
@endsection
    ...
    <section id="wsus__product_page" class="dynamic-pg py-5">
        <div class="container">
            <div class="position-relative">
                <img src="{{ asset('public/uploads/website-images/images/sales-site-agreement.png') }}" class="w-100 banner-img">
                <div class="position-absolute banner-section">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item" aria-current="page">Policy</li>
                            <li class="breadcrumb-item active" aria-current="page">Sales Site Agreement</li>
                        </ol>
                    </nav>
                    <h1 class="heading">Sales Site Agreement</h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <h4>Sales and Site Agreement</h4>
