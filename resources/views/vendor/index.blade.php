                    ...
                    <div class="row mt-3 mx-0">
                        <div class="col-md-4 px-1">
                            <div class="border rounded p-2 d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="mt-3 mb-2 per">Todays Sales</p>
                                    <h4>$20.4K</h4>
                        ...
                        <div class="col-md-4 px-1">
                            <div class="border rounded p-2 d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="mt-3 mb-2 per">Todays Revenue</p>
                                    <h4>$8.2K</h4>
                                    <p class="mt-2 mb-3">Availabale to payout</p>
                                </div>
                        ...
                        <div class="col-md-4 px-1">
                            <div class="border rounded p-2 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h4>1300</h4>
                                    <p class="mt-2 mb-3">Available to payout</p>
                                </div>
                                ...
                                <div class="d-flex mt-2 align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="small ms-2"><span
                                                class="fas fa-circle circle2 p-1"></span>Loss</small>
                                    </div>
                                </div>
                    ...
                    <div class="days-percentage mt-3 border rounded">
                        <div class="text-start d-flex align-items-center justify-content-between">
                            <div class="p-3">
                                ...
                                <p><strong class="text-danger">62%</strong> of all your orders came from North America Region
                                </p>
    ...
    <script>
        ...
        var chartData = {
            ...
            datasets: [{
                    ...
                    borderWidth: 0,
                    data: [95, 0, 70, 60, 65, 40, 60, 75, 65]
                },
                {
                    label: "",
                    backgroundColor: "#CCCCCC",
                    borderWidth: 0,
                    data: [60, 60, 55, 25, 80, 55, 25, 30, 55, 50]
                }
            ]
        };
