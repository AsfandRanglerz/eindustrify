...
Route::group(['middleware' => ['demo', 'XSS']], function () {
    ...
    Route::group(['middleware' => ['maintainance']], function () {
        ...
        Route::group(['as' => 'user.', 'prefix' => 'user'], function () {
            Route::get('dashboard', [UserProfileController::class, 'customerDashboard'])->name('dashboard');
        ...
        Route::group(['as' => 'vendor.', 'prefix' => '', 'middleware' => ['checkseller']], function () {
            ...
            Route::get('/taxes-duties', [VendorDashboardController::class, 'taxesDuties']);
            Route::get('/payments', [VendorDashboardController::class, 'vendorPayments']);
    ...
    Route::group(['as' => 'admin.', 'prefix' => 'admin'], function () {
        ...
        Route::delete('product-size-delete/{id}', [ProductSizeController::class, 'destroy'])->name('product-size-delete');
        ...
        Route::delete('product-overview-delete/{id}', [ProductOverviewController::class, 'destroy'])->name('product-overview-delete');
        ...
        Route::post('create-vendor', [VendorController::class, 'createVendor'])->name('create-vendor');
        ...
        Route::get('seller-show/{id}', [VendorController::class, 'show'])->name('seller-show');
        Route::put('seller-status/{id}', [VendorController::class, 'changeStatus'])->name('seller-status');
        Route::delete('seller-delete/{id}', [VendorController::class, 'destroy'])->name('seller-delete');
        Route::get('pending-seller-list', [VendorController::class, 'pendingSellerList'])->name('pending-seller-list');
        Route::put('seller-update/{id}', [VendorController::class, 'updateSeller'])->name('seller-update');
        Route::get('seller-shop-detail/{id}', [VendorController::class, 'sellerShopDetail'])->name('seller-shop-detail');
        Route::put('remove-seller-social-link/{id}', [VendorController::class, 'removeSellerSocialLink'])->name('remove-seller-social-link');
        Route::put('update-seller-shop/{id}', [VendorController::class, 'updateSellerSop'])->name('update-seller-shop');
        Route::get('seller-reviews/{id}', [VendorController::class, 'sellerReview'])->name('seller-reviews');
        Route::get('show-seller-review-details/{id}', [VendorController::class, 'showSellerReviewDetails'])->name('show-seller-review-details');
        Route::get('send-email-to-seller/{id}', [VendorController::class, 'sendEmailToSeller'])->name('send-email-to-seller');
        Route::post('send-mail-to-single-seller/{id}', [VendorController::class, 'sendMailtoSingleSeller'])->name('send-mail-to-single-seller');
        Route::get('email-history/{id}', [VendorController::class, 'emailHistory'])->name('email-history');
        Route::get('product-by-seller/{id}', [VendorController::class, 'productBySaller'])->name('product-by-seller');
        Route::get('send-email-to-all-seller', [VendorController::class, 'sendEmailToAllSeller'])->name('send-email-to-all-seller');
        ...
        Route::post('update-privacy-policy', [PolicyController::class, 'updatePrivacyPolicy'])->name('update-privacy-policy');
        ...
        Route::post('update-terms-registration', [PolicyController::class, 'updateTermsRegistration'])->name('update-terms-registration');
